...
emcc -O3 --closure 1 obj/main.o obj/ccanvas.o obj/camera.o obj/point.o obj/scene.o obj/vec3.o -o dest/index.js -s USE_SDL=2 -s EXPORTED_FUNCTIONS='["_CCanvas_dropEventForSDL","_main"]' -s EXPORTED_RUNTIME_METHODS='["ccall","cwrap"]' --preload-file base_scene.obj